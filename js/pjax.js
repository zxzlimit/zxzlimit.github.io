...
document.addEventListener('pjax:success', () => {
  ...
  if (CONFIG.sidebar.display !== 'remove') {
    ...
    // 恢复用户之前的侧边栏面板选择
    const savedPanel = localStorage.getItem('sidebar-panel-active');
    const defaultPanel = hasTOC ? 0 : 1;
    NexT.utils.activateSidebarPanel(savedPanel !== null ? parseInt(savedPanel) : defaultPanel);
